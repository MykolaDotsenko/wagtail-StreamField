...
The repository currently targets Django 5.2 and Wagtail 7.4 LTS. Prefer version-matched docs for framework behavior.
...
Usage guide:
- https://docs.wagtail.org/en/7.4/topics/
...
Search:
- https://docs.wagtail.org/en/7.4/topics/search/

Images:
- https://docs.wagtail.org/en/7.4/topics/images.html

Customizing Wagtail:
- https://docs.wagtail.org/en/7.4/advanced_topics/customization/

Hooks:
- https://docs.wagtail.org/en/7.4/reference/hooks.html

Accessibility considerations:
- https://docs.wagtail.org/en/7.4/advanced_topics/accessibility_considerations.html

Testing:
- https://docs.wagtail.org/en/7.4/advanced_topics/testing.html
